...
public class ItemController {
	...
	public ModelAndView goToStandartSearch(@RequestParam(defaultValue = "") String nnSapUI,  @RequestParam(defaultValue = "") String nnUI, @RequestParam(defaultValue = "") String nameUI) {
